...
- Cập nhật mô hình dữ liệu, use case, sơ đồ tuần tự và sơ đồ hoạt động theo nghiệp vụ hiện hành.
...
- Mục lục dùng cấp 1–3 và có 51 liên kết nội bộ.
- Danh mục hình có 46 mục, 46 bookmark và 46 liên kết hợp lệ.
- Tổng cộng 97 liên kết nội bộ và 18 liên kết ngoài; không có anchor hoặc bookmark bị lỗi.
- Không có comment, tracked changes, page border hoặc thông báo lỗi field của Word.
- DOCX đã được kiểm tra cấu trúc và các trang bị tác động đã được kiểm tra trực quan.

PDF không được duy trì trong checkpoint ở giai đoạn chỉnh sửa nhanh; chỉ xuất lại khi người dùng yêu cầu bản bàn giao PDF cuối cùng.
