...
/// <summary>
/// Fail-closed contract for the disposable QA database used by integration and
/// browser tests. This contract intentionally accepts only a unique LocalDB
/// instance created for one test run.
/// </summary>
