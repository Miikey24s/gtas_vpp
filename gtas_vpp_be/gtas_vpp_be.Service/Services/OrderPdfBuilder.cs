...
/// <summary>
/// Renders a single order as an A4 PDF sheet using QuestPDF (Community license).
/// The layout follows the approved Atlas order-sheet motif: header with order
/// code and status, a field grid, the item table and the order note.
/// </summary>
