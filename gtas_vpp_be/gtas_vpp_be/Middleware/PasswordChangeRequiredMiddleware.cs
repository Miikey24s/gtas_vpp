...
/// <summary>
/// A temporary administrator password must not grant access to business APIs.
/// Authentication enriches the principal from the current account record on
/// every request; this boundary only permits password change and logout until
/// the flag is cleared and existing sessions are revoked.
/// </summary>
