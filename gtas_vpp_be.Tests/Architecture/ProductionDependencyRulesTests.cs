...
public sealed class ProductionDependencyRulesTests
{
    ...
    private static readonly IReadOnlyDictionary<string, string[]> ExpectedProjectReferences =
        ...
        {
            ["gtas_vpp_be/gtas_vpp_shared/gtas_vpp_shared.csproj"] = [],
            ["gtas_vpp_be/gtas_vpp_be.Model/gtas_vpp_be.Model.csproj"] = [],
            ["gtas_vpp_be/gtas_vpp_be.Migrations/gtas_vpp_be.Migrations.csproj"] =
            [
                "gtas_vpp_be/gtas_vpp_be.model/gtas_vpp_be.model.csproj"
            ],
            ["gtas_vpp_be/gtas_vpp_be.Service/gtas_vpp_be.Service.csproj"] =
            [
                "gtas_vpp_be/gtas_vpp_be.model/gtas_vpp_be.model.csproj",
                "gtas_vpp_be/gtas_vpp_shared/gtas_vpp_shared.csproj"
            ],
            ...
            ["MyAspire.AppHost/MyAspire.AppHost.csproj"] =
            [
                "gtas_vpp_be/gtas_vpp_be/gtas_vpp_be.csproj",
                "gtas_vpp_fe/gtas_vpp_fe/gtas_vpp_fe/gtas_vpp_fe.csproj"
            ],
            ["MyAspire.ServiceDefaults/MyAspire.ServiceDefaults.csproj"] = []
        };
    ...
    public void SharedContracts_HaveNoPackageDependencies()
    {
        var project = Path.Combine(
            RepositoryRoot,
            ToPlatformPath("gtas_vpp_be/gtas_vpp_shared/gtas_vpp_shared.csproj"));
    ...
    public void Frontend_HasNoPersistenceOrObjectMappingPackage()
    {
        var project = Path.Combine(
            RepositoryRoot,
            ToPlatformPath("gtas_vpp_fe/gtas_vpp_fe/gtas_vpp_fe/gtas_vpp_fe.csproj"));
