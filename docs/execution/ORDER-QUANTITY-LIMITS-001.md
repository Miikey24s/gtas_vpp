...
- Giới hạn theo **mỗi mặt hàng / mỗi nhân viên / mỗi kỳ đặt hàng**.
...
- Để trống nghĩa là không giới hạn. Không dùng `0`; muốn ngừng đặt thì vô hiệu hóa mặt hàng.
...
- Max phải lớn hơn `0` nếu có giá trị.
...
2. Nếu không có, lấy policy mặc định toàn công ty theo cùng quy tắc.
3. Nếu vẫn không có hoặc giá trị là `null`, mặt hàng không bị giới hạn.
...
```text
Số còn có thể đặt = Giới hạn kỳ - Số đã dùng ở các đơn khác
```
...
> Giấy A4 được đặt tối đa 20 Ram trong kỳ 08/2026. Bạn đã đặt 15 Ram, còn có thể đặt 5 Ram.
...
- Dưới tên/đơn vị mặt hàng hiển thị dòng phụ `Tối đa 20 Ram trong kỳ · Còn 5` khi có giới hạn.
- Stepper dùng mức còn lại thật; nút `+` mờ khi đạt giới hạn nhưng vẫn giữ Stable Capability Surface.
...
- `Danh mục mặt hàng`: action cấu hình giới hạn riêng; để trống là dùng mức mặc định.
- Hiển thị trước câu dễ hiểu: `Áp dụng từ kỳ 09/2026 · Tối đa 20/người/kỳ`.
