...
| **AA3 — Items, suppliers, departments** | **IN PROGRESS — SUPPLIER + ITEM SLICES** | **Terra · High implement; Sol · High review** | Migrate ba Collection grid, typed editor, hierarchy validation, bỏ reflection inline edit | Supplier + Item đã full-width + typed editor; Department còn lại | API validation, 390–1920, no document scroll |
