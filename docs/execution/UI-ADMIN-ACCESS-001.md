...
| **AA3 — Items, suppliers, departments** | **IN PROGRESS — THREE UI SLICES COMPLETE** | **Terra · High implement; Sol · High review** | Migrate ba Collection grid, typed editor, hierarchy validation, bỏ reflection inline edit | Item/Supplier/Department đã typed full-width; hardening còn lại | API hierarchy/dependency validation, 390–1920 matrix pending |
...
- Backend cycle/descendant validation, dependency impact Supplier/Department và visual matrix AA3 vẫn pending trước khi đóng wave.
