...
- Cột mặc định phải ưu tiên dữ liệu giúp ra quyết định ngay: nhận diện, trạng thái, số bản ghi liên quan và độ mới quan trọng. Metadata tra cứu ít dùng như lần nhập/lần đăng nhập, địa chỉ thành phần hoặc resource identifier vẫn `Pickable="true"` nhưng `Visible="false"`.
