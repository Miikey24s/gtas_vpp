...
- Giới hạn số lượng đặt hàng chưa triển khai. Execution plan chờ duyệt nằm tại [`ORDER-QUANTITY-LIMITS-001`](../execution/ORDER-QUANTITY-LIMITS-001.md); hướng khuyến nghị là giới hạn mỗi mặt hàng/mỗi nhân viên/mỗi kỳ, có mức mặc định và override theo mặt hàng, hiệu lực từ kỳ được chọn.
