...
| 13 Danh sách bảng giá | `/library?tab=6&pricingTab=price-lists` | ISOLATED_QA_PASS — OWNER_REVIEW | Collection server-paged; Giá/Sửa/Thêm trực tiếp, lifecycle còn lại trong menu; publish/expire/default/clone/active/hard-delete thật |
