...
namespace gtas_vpp_be.Service.Helpers.Context
{
    public class VPPContext : IdentityUserContext<AppUser, int>
    {
        ...
        public virtual DbSet<StoredProcedureResultDTO> StoredProcedureResults { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<StoredProcedureResultDTO>().HasNoKey();
