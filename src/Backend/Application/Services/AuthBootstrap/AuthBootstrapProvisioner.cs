...
/// <summary>
/// Tạo application owner đáng tin cậy đầu tiên sau khi cô lập tài khoản demo legacy.
/// Class này chủ động không được expose qua HTTP và chỉ được gọi bởi startup mode
/// migration/reference-seed một lần có guard.
/// </summary>
public sealed class AuthBootstrapProvisioner : IAuthBootstrapProvisioner
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch
        {
            ...
            {
                // Giữ nguyên lỗi provisioning. Dispose cũng cố rollback relational
        ...
        string primaryDepartmentName)
    {
        ...
        // Chủ động loại mật khẩu ban đầu. Lần chạy lại ở trạng thái completed sẽ
        // kiểm tra bằng salted hash của Identity mà không lưu thêm giá trị dẫn xuất
        // từ mật khẩu vào ledger không chứa secret.
