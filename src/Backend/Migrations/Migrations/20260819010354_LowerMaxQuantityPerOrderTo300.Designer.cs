...
namespace gtas_vpp_be.Migrations.Migrations
{
    ...
    [Migration("20260819010354_LowerMaxQuantityPerOrderTo300")]
    partial class LowerMaxQuantityPerOrderTo300
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("gtas_vpp_be.Model.Library.VppItem", b =>
                {
                    ...
                    b.ToTable("VppItems", t =>
                        {
                            t.HasCheckConstraint("CK_VppItems_MaxQuantityPerOrder_Range", "[MaxQuantityPerOrder] >= 1 AND [MaxQuantityPerOrder] <= 300");
                        });
                });
