...
function positionHistoryTransientSurfaces(root) {
    ...
    // Ancestor có transform có thể khiến phần tử fixed dùng containing block local.
    // Hiệu chỉnh tọa độ local theo rectangle thực tế đã render, không chỉ khi vượt biên,
    // để surface luôn neo chính xác vào trigger.
