...
public static class UiRouteCatalog
{
    ...
    private static IReadOnlyDictionary<string, Profile> BuildProfiles()
    {
        ...
        Add(profiles, ["dashboard.my-orders", "dashboard.my-orders.current", "dashboard.my-orders.supplement"], WorkspacePattern.Analytics, DataSourceMode.Mixed, Density.Mixed, ToolbarMotif.Filter, FooterMotif.Mixed, ResponsiveStrategy.OverlayDetail, ["ANALYTICS", "SELECTOR-DECISION", "FILTER-TOOLBAR", "DATA-FRAME", "DATA-FOOTER", "CELL-VALUE", "CONTENT-STATE", "TRANSIENT"], ["loading", "empty", "filtered-empty", "error", "disabled"]);
        ...
        Add(profiles, ["dashboard.period.periods"], WorkspacePattern.Collection, DataSourceMode.Mixed, Density.Compact, ToolbarMotif.None, FooterMotif.Mixed, ResponsiveStrategy.BoundedSurface, ["COLLECTION", "HEADER-TAB-GROUP", "COLLECTION-HEADER", "DATA-FRAME", "DATA-COLUMN", "DATA-FOOTER", "ADMIN-ROW-ACTIONS", "DIALOG-EDITOR", "STATUS-BADGE", "CONTENT-STATE", "TRANSIENT"], ["loading", "empty", "error", "denied", "disabled", "success"], "Order periods use the canonical admin collection, automatic schedule closing, dialog detail and capability-driven edit, extend, reopen and settlement actions.");
        Add(profiles, ["dashboard.period-operations", "dashboard.period.pending-approval", "dashboard.period.review", "dashboard.period.demand", "dashboard.period.supply", "dashboard.period.settle"], WorkspacePattern.Operation, DataSourceMode.Mixed, Density.Mixed, ToolbarMotif.Decision, FooterMotif.Mixed, ResponsiveStrategy.BoundedSurface, ["OPERATION", "HEADER-TAB-GROUP", "SELECTOR-DECISION", "FILTER-TOOLBAR", "DATA-FRAME", "DATA-FOOTER", "DIALOG-EDITOR", "CONTENT-STATE", "TRANSIENT"], ["loading", "empty", "filtered-empty", "error", "denied", "disabled", "success"], "Period approval and settlement steps retain the operation workspace; legacy review/demand/supply/settle values remain compatible.");
        Add(profiles, ["dashboard.order-create.new", "dashboard.order-create.additional", "dashboard.order-create.copy-previous", "dashboard.order-create.edit", "dashboard.order-create.recreate"], WorkspacePattern.SplitEditor, DataSourceMode.Mixed, Density.RichTwoLine, ToolbarMotif.Workflow, FooterMotif.ActionBar, ResponsiveStrategy.StackPanes, ["SPLIT-EDITOR", "OPERATION", "FILTER-TOOLBAR", "DATA-FRAME", "DATA-FOOTER", "CELL-VALUE", "CONTENT-STATE", "TRANSIENT"], ["loading", "empty", "filtered-empty", "error", "disabled", "success"]);

        Add(profiles, ["library.classes"], WorkspacePattern.SplitEditor, DataSourceMode.ServerPaging, Density.Compact, ToolbarMotif.FilterWithColumnPicker, FooterMotif.Paged, ResponsiveStrategy.StackPanes, ["SPLIT-EDITOR", "COLLECTION-HEADER", "FILTER-TOOLBAR", "DATA-FRAME", "DATA-COLUMN", "DATA-FOOTER", "ADMIN-ROW-ACTIONS", "DIALOG-EDITOR", "CONTENT-STATE"], ["loading", "empty", "filtered-empty", "error", "disabled"]);
        Add(profiles, ["library.categories", "library.items", "library.suppliers", "library.departments", "library.pricing.price-lists", "library.pricing.prices", "library.pricing.prices.selected-list"], WorkspacePattern.Collection, DataSourceMode.ServerPaging, Density.Compact, ToolbarMotif.FilterWithColumnPicker, FooterMotif.Paged, ResponsiveStrategy.BoundedSurface, ["COLLECTION", "COLLECTION-HEADER", "FILTER-TOOLBAR", "DATA-FRAME", "DATA-COLUMN", "DATA-FOOTER", "ADMIN-ROW-ACTIONS", "DIALOG-EDITOR", "CONTENT-STATE"], ["loading", "empty", "filtered-empty", "error", "denied", "disabled"]);

        Add(profiles, ["permission.user"], WorkspacePattern.Collection, DataSourceMode.ServerPaging, Density.Compact, ToolbarMotif.FilterWithColumnPicker, FooterMotif.Paged, ResponsiveStrategy.BoundedSurface, ["COLLECTION", "COLLECTION-HEADER", "FILTER-TOOLBAR", "DATA-FRAME", "DATA-COLUMN", "DATA-FOOTER", "ADMIN-ROW-ACTIONS", "DIALOG-EDITOR", "CONTENT-STATE"], ["loading", "empty", "filtered-empty", "error", "denied", "disabled"]);
        Add(profiles, ["permission.component"], WorkspacePattern.ListDetail, DataSourceMode.ServerPaging, Density.Compact, ToolbarMotif.FilterWithColumnPicker, FooterMotif.Mixed, ResponsiveStrategy.StackPanes, ["LIST-DETAIL", "FILTER-TOOLBAR", "DATA-FRAME", "DATA-COLUMN", "DATA-FOOTER", "ADMIN-ROW-ACTIONS", "DIALOG-EDITOR", "CONTENT-STATE"], ["loading", "empty", "filtered-empty", "error", "denied", "disabled"]);
        Add(profiles, ["permission.security-audit"], WorkspacePattern.Collection, DataSourceMode.ServerPaging, Density.Compact, ToolbarMotif.FilterWithColumnPicker, FooterMotif.Paged, ResponsiveStrategy.BoundedSurface, ["COLLECTION", "FILTER-TOOLBAR", "DATA-FRAME", "DATA-COLUMN", "DATA-FOOTER", "ADMIN-ROW-ACTIONS", "CONTENT-STATE"], ["loading", "empty", "filtered-empty", "error", "denied"]);
        Add(profiles, ["permission.order-period-settings"], WorkspacePattern.Operation, DataSourceMode.Mixed, Density.Compact, ToolbarMotif.None, FooterMotif.Mixed, ResponsiveStrategy.BoundedSurface, ["OPERATION", "DATA-FRAME", "COLLECTION-HEADER", "DATA-COLUMN", "DATA-FOOTER", "CONTENT-STATE", "FEEDBACK"], ["loading", "empty", "error", "denied", "disabled", "success"], "System administrators create immutable settings versions; existing period instances keep their stored schedules.");
