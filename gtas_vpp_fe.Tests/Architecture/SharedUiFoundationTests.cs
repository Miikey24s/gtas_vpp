...
public sealed class SharedUiFoundationTests
{
    ...
    public void SharedTabs_MirrorSidebarGeometryAndPagesDoNotDuplicateTabHeadings()
    {
        ...
        Assert.Contains("translate: var(--vpp-optical-x, 0px) var(--vpp-optical-y, 0px);", tabsCss, StringComparison.Ordinal);
        Assert.Contains("function alignOpticalTextElement(element)", interactionsJs, StringComparison.Ordinal);
        Assert.Contains("metrics.actualBoundingBoxAscent", interactionsJs, StringComparison.Ordinal);
        Assert.Contains("metrics.actualBoundingBoxLeft", interactionsJs, StringComparison.Ordinal);
        Assert.Contains("element.dataset.vppInkWidth", interactionsJs, StringComparison.Ordinal);
        Assert.Contains("element.dataset.vppInkCenterX", interactionsJs, StringComparison.Ordinal);
        Assert.Contains("var title = target.querySelector(\".rz-tabview-title\");", interactionsJs, StringComparison.Ordinal);
        Assert.Contains("--vpp-primary-tab-indicator-preferred-width: 72px;", tabsCss, StringComparison.Ordinal);
        Assert.Contains("function readPrimaryTabIndicatorWidth(tabList)", interactionsJs, StringComparison.Ordinal);
        Assert.Contains("Math.min(preferredWidth, shortestInkWidth)", interactionsJs, StringComparison.Ordinal);
        Assert.Contains("Math.min(commonIndicatorWidth, measuredIndicatorWidth)", interactionsJs, StringComparison.Ordinal);
    ...
    public void SidebarNavigation_UsesAppleMusicInspiredRowStates()
    {
        ...
        Assert.Contains("translate: var(--vpp-optical-x, 0px) var(--vpp-optical-y, 0px);", layoutCss, StringComparison.Ordinal);
